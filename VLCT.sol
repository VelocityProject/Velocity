 ...
 * Invest and hold to reap the full benefits of owning Velocity!
 * 
 * Deflationary tokenomics
 * --------------- 
 * 2% of each transation will be burned
 * increasing the value of the holders' tokens.
 * 
 * Stabilizing the Price
 * ---------------- 
 * 3% of each transaction will be added to the liquidity pool 
 * stabilizing the token price.
 * 
 * Hold and Earn
 * ------------------
 * 4% of each transation is distributed
 * to all Velocity holders
 * 
 * Marketing and operations
 * ---------------
 * 1% will be sent to marketing Velocity
 * and supporting daily operations.
 * 
 * Enjoy lowered fees (1% to each category) for the
 * first two weeks after launch
 * Start holding early and earn benefits down the road
 * 
 * Tokenomics
 * ----------
 ...
 * Liquidity    :        			50%
 * 
 * No team allocation, no hidden agenda, 100% rug-pull-proof(tm)
 * 
*/
...
contract Velocity is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x60A74a1fc6E29F83594e62fa23b60019fF590d23;
    ...
    constructor () public {
        ...
        //exclude the owner, the marketing wallet and this contract from fee
